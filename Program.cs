...
{
    // УПРОЩЕННЫЕ настройки пароля для учебного проекта
    options.Password.RequireDigit = false;          // Цифры не обязательны
    options.Password.RequireLowercase = false;      // Строчные буквы не обязательны
    ...
    options.Password.RequiredLength = 3;            // Минимальная длина 3 символа
